...
class TradeMini:
    ...
    def _on_tick_received(self, tick: TickData):
        ...
        try:
            ...
            if signal.signal_type != SignalType.NONE:
                ...
                logger.info(f"Signal generated: {signal.symbol} {signal.signal_type.value} @ {signal.price:.6f} - {signal.reason}")
    ...
    def _log_statistics(self):
        ...
        try:
            ...
            position_stats = self.position_manager.get_stats() if self.position_manager else {}
            questdb_stats = self.questdb_client.get_stats() if self.questdb_client else {}
            
            # ポートフォリオ要約
            portfolio = self.position_manager.get_portfolio_summary() if self.position_manager else {}
            ...
            logger.info(f"Account balance: {portfolio.get('account_balance', 0):.2f} USDT")
            logger.info(f"Total unrealized PnL: {portfolio.get('total_unrealized_pnl', 0):.2f} USDT")
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "stats": self.stats,
                "data_manager": self.data_manager.get_stats() if self.data_manager else {},
                ...
                "questdb": self.questdb_client.get_stats() if self.questdb_client else {},
                "portfolio": self.position_manager.get_portfolio_summary() if self.position_manager else {},
            }
        except Exception as e:
